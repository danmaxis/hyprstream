...
const manifestPath = resolve(root, "com.danmaxis.hyprstream.sdPlugin", "manifest.json");
const manifest = JSON.parse(readFileSync(manifestPath, "utf8"));
const version = manifest.Version.split(".").slice(0, 3).join(".");

const distDir = resolve(root, "dist");
const outFile = resolve(distDir, `hyprstream-${version}.streamDeckPlugin`);
...
root = sys.argv[1]
out = sys.argv[2]
plugin_dir = "com.danmaxis.hyprstream.sdPlugin"
...
const res = spawnSync("python3", ["-c", py, root, outFile], { stdio: "inherit" });
